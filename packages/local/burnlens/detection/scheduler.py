...
def register_alert_jobs(
    ...
    # Job 1: hourly real-time discovery alert checks
    scheduler.add_job(
    ...
    # Job 2: daily digest at 8 AM UTC
    scheduler.add_job(
        _run_daily_digest,
    ...
    # Job 3: weekly digest every Monday at 8 AM UTC
    scheduler.add_job(
        _run_weekly_digest,
...
# ---------------------------------------------------------------------------
# Alert job wrapper functions (fail-open)
# ---------------------------------------------------------------------------

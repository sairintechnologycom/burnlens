...
const faqStructuredData = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "BurnLens is the closest one-line drop-in alternative. Install with pip, set one environment variable, and every OpenAI, Anthropic, Google, Azure OpenAI, AWS Bedrock, Groq, Mistral, Together, xAI, and DeepSeek call is tracked with cost attribution and hard-cap budget enforcement.",
      },
    },
    {
      "@type": "Question",

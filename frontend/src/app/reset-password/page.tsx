...
function ResetPasswordForm() {
  ...
  if (!token) {
    return (
      <div className="sp-form-area">
        <div className="sp-form-title">Reset password</div>
        <p className="sp-form-sub">
          This link is invalid or has expired. Request a new one from the sign-in page.
        </p>
        <Link href="/setup" className="sp-btn-primary" style={{ display: "inline-block", textAlign: "center", textDecoration: "none", marginTop: 8 }}>
          Back to sign in
        </Link>
      </div>
    );
  ...
  if (success) {
    return (
      <div className="sp-form-area">
        <div className="sp-form-title">Password updated</div>
        <p className="sp-form-sub">You can now sign in with your new password.</p>
        <p className="sp-form-sub">Redirecting to sign in&hellip;</p>
      </div>
    );
  }
  ...
  return (
    <div className="sp-form-area">
      <div className="sp-form-title">Set a new password</div>
      <p className="sp-form-sub">Choose a strong password — at least 8 characters.</p>
        ...
        <div className="sp-main">
          ...
          <div className="sp-right">
            <Suspense
              fallback={
                <div className="sp-form-area">
                  <p style={{ color: "var(--s-muted)", fontSize: 13 }}>Loading&hellip;</p>
                </div>
              }
            >
              <ResetPasswordForm />

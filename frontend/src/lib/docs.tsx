...
export const COMMANDS: { cmd: string; what: string; group: string }[] = [
  ...
  { group: "Operate", cmd: "cloud connect", what: "Connect local cost metadata to a BurnLens Cloud workspace. Prompt bodies are never uploaded." },
  { group: "Operate", cmd: "login", what: "Authenticate with burnlens.app and enable cloud sync (same as cloud connect)." },

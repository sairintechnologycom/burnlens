...
class AiAsset:
    ...
    first_seen_at: datetime = field(default_factory=datetime.utcnow)  # When first detected
    last_active_at: datetime = field(default_factory=datetime.utcnow)  # Most recent activity
...
class DiscoveryEvent:
    ...
    detected_at: datetime = field(default_factory=datetime.utcnow)  # When event occurred
